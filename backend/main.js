...
const URL_BANCO_DE_DADOS = process.env.MONGO_URI || 'mongodb://localhost:27017/tarefas';
...
mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/tarefas').then(() => {
